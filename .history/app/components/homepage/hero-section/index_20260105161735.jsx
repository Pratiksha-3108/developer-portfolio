...
function HeroSection() {
  return (
    <section className="relative flex flex-col items-center px-4 sm:px-6 lg:px-10 pt-28 lg:pt-32 py-6 lg:py-16 overflow-x-hidden">
      {/* Background */}
      <Image
        src="/hero.svg"
        alt="Hero background"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-7xl w-full">
        ...
        <div className="order-2 lg:order-1 flex flex-col">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-extrabold leading-tight text-white">
            Hi, I&apos;m <span className="text-pink-500">Pratiksha Jadhav</span>
          </h1>
          ...
          <p className="mt-6 max-w-xl text-sm sm:text-base text-gray-300 leading-relaxed">
            ...
            experience in <span className="text-pink-400">TypeScript</span> and{" "}
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <Link href={personalData.resume} target="_blank" className="flex items-center gap-2 bg-gradient-to-r from-pink-500 to-violet-600 px-6 py-3 rounded-full text-sm uppercase tracking-wider text-white hover:gap-3 transition">
