...
export const skillsImage = (skill) => {
  ...
  switch (skillID) {
    ...
    case 'css': return css;
    case 'js': return javascript; // fixed
    case 'typescript': return typescript;
    case 'react': return react;
    case 'next js': return nextJS;
    case 'tailwind': return tailwind; // fixed typo
    case 'node js': return nextJS; // Node icon not included, optional
    case 'java': return java;
    case 'python': return python; // fixed case
    case 'c': return c;
    ...
    default: return null; // unknown skills like Express JS & Power BI
  }
}
